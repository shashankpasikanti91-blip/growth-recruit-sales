...
const config = {
  ...
  // Demo account
  DEMO_USER_EMAIL: process.env.DEMO_USER_EMAIL || 'demo@tekgen.com',
  DEMO_USER_PASSWORD: process.env.DEMO_USER_PASSWORD || 'Demo@1234',
  DEMO_USER_FIRST_NAME: process.env.DEMO_USER_FIRST_NAME || 'Demo',
  DEMO_USER_LAST_NAME: process.env.DEMO_USER_LAST_NAME || 'Recruiter',
