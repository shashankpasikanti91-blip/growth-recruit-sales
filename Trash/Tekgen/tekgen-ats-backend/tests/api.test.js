...
describe('Candidate Endpoints', () => {
  ...
  beforeAll(async () => {
    ...
    const user = await authService.register('test@test.com', 'TestPass123', 'Test', 'User');
    jwtToken = user.token;
...
describe('Job Endpoints', () => {
  ...
  beforeAll(async () => {
    const user = await authService.register('recruiter@test.com', 'TestPass123', 'Recruiter', 'Test');
    jwtToken = user.token;
  });
...
describe('Screening Endpoints', () => {
  ...
  beforeAll(async () => {
    const user = await authService.register('screen@test.com', 'TestPass123', 'Screen', 'Test');
    jwtToken = user.token;
...
describe('Analytics Endpoints', () => {
  ...
  beforeAll(async () => {
    const user = await authService.register('analytics@test.com', 'TestPass123', 'Analytics', 'Test');
    jwtToken = user.token;
  });
...
describe('Export Endpoints', () => {
  ...
  beforeAll(async () => {
    const user = await authService.register('export@test.com', 'TestPass123', 'Export', 'Test');
    jwtToken = user.token;
  });
