...
**Access:** HR Admin, Management, Super Admin  
...
|-------|---------|--------|
| Level 1 | Reporting Manager (if configured) OR Main Admin | Approve / Reject / Clarify |
| Level 2 (optional) | HR Admin | Policy + document check |
| Final (optional) | Main Admin | Sensitive or long leave |
| Payroll sync | Payroll Admin only | Approved No-Pay Leave affects payroll calculation |
