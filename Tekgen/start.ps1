...
function Start-Servers {
    ...
    # Build frontend static export used by backend
    ...
    Write-Host "  Dev seed accounts: shared/demoWorkspaceAccounts.js (restart API after edits)" -ForegroundColor White
    Write-Host ("=" * 50) -ForegroundColor Green
    Write-Host ""
