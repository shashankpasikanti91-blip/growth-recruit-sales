...
{{contextData}}`,
  ...
  const leadsData = [
    ...
    { id: 'lead-3', companyId: 'comp-greentech', contactId: 'cont-lisa', firstName: 'Lisa', lastName: 'Ng', email: 'lisa.ng@greentech.my', phone: '+60-11-2233-4455', title: 'CTO', stage: 'CONTACTED' as const, score: 74, icpId: 'icp-default', painPoints: ['Need senior engineers', 'Budget constraints'], notes: 'Small team but growing. Budget-conscious.', sourceName: 'Website' },
    { id: 'lead-4', companyId: 'comp-acme', contactId: 'cont-mike', firstName: 'Mike', lastName: 'Reynolds', email: 'mike@acmedigital.co', phone: '+61-4-5678-9012', title: 'Founder & CEO', stage: 'NEW' as const, score: 65, icpId: 'icp-default', painPoints: ['Client churn', 'Data analyst shortage'], notes: 'Inbound from pricing page.', sourceName: 'Website' },
    ...
    { id: 'lead-6', firstName: 'Ahmad', lastName: 'Hassan', email: 'ahmad@techstartup.my', title: 'Founder', stage: 'NEW' as const, score: 55, painPoints: ['No ATS', 'Manual screening'], notes: 'Early stage startup, 5 employees.', sourceName: 'LinkedIn' },
    { id: 'lead-7', firstName: 'Wei Lin', lastName: 'Tan', email: 'weilin@datawave.sg', title: 'HR Director', stage: 'QUALIFIED' as const, score: 81, painPoints: ['High volume hiring', 'Slow time-to-hire'], notes: 'Hiring 30+ per month. Current ATS is too slow.', sourceName: 'Referral' },
    { id: 'lead-8', firstName: 'Rachel', lastName: 'Wong', email: 'rachel@cloudnine.com.au', title: 'People & Culture Lead', stage: 'CONTACTED' as const, score: 70, painPoints: ['DEI tracking', 'Candidate experience'], notes: 'Wants better candidate experience tools.', sourceName: 'Website' },
  ];
  ...
  const jobsData = [
    {
      id: 'job-swe', title: 'Senior Software Engineer', department: 'Engineering', location: 'Kuala Lumpur, Malaysia', countryCode: 'MY',
    ...
    {
      id: 'job-fe', title: 'Frontend Developer (React)', department: 'Engineering', location: 'Remote (APAC)', countryCode: 'MY',
    ...
    {
      id: 'job-ds', title: 'Data Scientist', department: 'AI/ML', location: 'Singapore', countryCode: 'SG',
    ...
    {
      id: 'job-pm', title: 'Product Manager', department: 'Product', location: 'Kuala Lumpur, Malaysia', countryCode: 'MY',
    ...
    {
      id: 'job-sales', title: 'Business Development Rep', department: 'Sales', location: 'Remote (APAC)', countryCode: 'MY',
  ...
  const applicationsData = [
    { id: 'app-1', tenantId: tenant.id, candidateId: 'cand-1', jobId: 'job-swe', stage: 'INTERVIEWING' as const, matchScore: 92, isShortlisted: true, isInterview: true, scoreDetails: { skill_match: 95, experience_match: 90, education_match: 85 } },
    { id: 'app-2', tenantId: tenant.id, candidateId: 'cand-2', jobId: 'job-fe', stage: 'SCREENED' as const, matchScore: 88, isShortlisted: true, scoreDetails: { skill_match: 92, experience_match: 85, education_match: 80 } },
    ...
    { id: 'app-10', tenantId: tenant.id, candidateId: 'cand-10', jobId: 'job-ds', stage: 'SCREENED' as const, matchScore: 82, isShortlisted: true, scoreDetails: { skill_match: 85, experience_match: 78, education_match: 82 } },
  ];
  ...
  const activitiesData = [
    { id: 'act-1', tenantId: tenant.id, userId: admin.id, candidateId: 'cand-1', type: 'IMPORT' as const, title: 'Candidate imported', description: 'Imported from CSV upload', createdAt: daysAgo(14) },
    { id: 'act-2', tenantId: tenant.id, userId: admin.id, candidateId: 'cand-1', type: 'AI_ANALYSIS' as const, title: 'AI screening completed', description: 'Score: 92/100 — Strong Shortlist. Excellent Node.js/TypeScript match.', createdAt: daysAgo(13) },
    { id: 'act-3', tenantId: tenant.id, userId: admin.id, candidateId: 'cand-1', type: 'STAGE_CHANGE' as const, title: 'Moved to Interviewing', description: 'Auto-promoted after AI screening score > 85.', createdAt: daysAgo(12) },
    { id: 'act-4', tenantId: tenant.id, userId: admin.id, candidateId: 'cand-1', type: 'NOTE' as const, title: 'Recruiter note', description: 'Great communication in phone screen. Available to start in 2 weeks.', createdAt: daysAgo(10) },
    { id: 'act-5', tenantId: tenant.id, userId: admin.id, candidateId: 'cand-3', type: 'AI_ANALYSIS' as const, title: 'AI screening completed', description: 'Score: 95/100 — Strong Shortlist. Top candidate for Data Scientist role.', createdAt: daysAgo(11) },
    { id: 'act-6', tenantId: tenant.id, userId: admin.id, candidateId: 'cand-3', type: 'STAGE_CHANGE' as const, title: 'Offered', description: 'Extended offer after final round interview.', createdAt: daysAgo(5) },
    { id: 'act-7', tenantId: tenant.id, userId: admin.id, leadId: 'lead-2', type: 'EMAIL_SENT' as const, title: 'Proposal sent', description: 'Sent pricing proposal to James Tan at Stellar Corp.', createdAt: daysAgo(7) },
    { id: 'act-8', tenantId: tenant.id, userId: admin.id, leadId: 'lead-5', type: 'MEETING' as const, title: 'Demo call', description: 'Conducted product demo for MedFlow Health team. Very positive response.', createdAt: daysAgo(3) },
    { id: 'act-9', tenantId: tenant.id, userId: admin.id, leadId: 'lead-1', type: 'CALL' as const, title: 'Discovery call', description: 'Discussed pain points with Sarah Chen. They need AI screening ASAP.', createdAt: daysAgo(9) },
    { id: 'act-10', tenantId: tenant.id, userId: admin.id, candidateId: 'cand-8', type: 'STAGE_CHANGE' as const, title: 'Placed', description: 'Priyanka accepted the BDR offer. Start date: March 25.', createdAt: daysAgo(2) },
    { id: 'act-11', tenantId: tenant.id, userId: admin.id, type: 'IMPORT' as const, title: 'Bulk import completed', description: '10 candidates imported from CSV file. 0 duplicates.', createdAt: daysAgo(14) },
    { id: 'act-12', tenantId: tenant.id, userId: admin.id, candidateId: 'cand-2', type: 'OUTREACH_SENT' as const, title: 'Outreach email sent', description: 'AI-generated introduction email about Frontend Developer role.', createdAt: daysAgo(8) },
  ];
  ...
  // ─── Seed Workflow Runs ─────────────────────────────────────────────────────
  const workflowData = [
    { id: 'wf-1', tenantId: tenant.id, workflowType: 'CANDIDATE_IMPORTED' as const, status: 'SUCCESS' as const, triggeredBy: 'system', startedAt: daysAgo(14), completedAt: daysAgo(14) },
    { id: 'wf-2', tenantId: tenant.id, workflowType: 'LEAD_IMPORTED' as const, status: 'SUCCESS' as const, triggeredBy: 'system', startedAt: daysAgo(14), completedAt: daysAgo(14) },
    { id: 'wf-3', tenantId: tenant.id, workflowType: 'OUTREACH_DRAFT_GENERATION' as const, status: 'SUCCESS' as const, triggeredBy: admin.id, startedAt: daysAgo(12), completedAt: daysAgo(12) },
    { id: 'wf-4', tenantId: tenant.id, workflowType: 'SCHEDULED_ENRICHMENT' as const, status: 'SUCCESS' as const, triggeredBy: 'cron', startedAt: daysAgo(7), completedAt: daysAgo(7) },
    { id: 'wf-5', tenantId: tenant.id, workflowType: 'FOLLOW_UP_REMINDER' as const, status: 'RUNNING' as const, triggeredBy: 'cron', startedAt: new Date() },
  ];
